...
const (
	...
	Person_PHONE_TYPE_HOME        Person_PhoneType = 1
	Person_PHONE_TYPE_MOBILE      Person_PhoneType = 2
...
func (x *Person_AddressBook) Reset() {
	*x = Person_AddressBook{}
	if protoimpl.UnsafeEnabled {
...
func (x *Person_AddressBook) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Person_AddressBook) ProtoMessage() {}

func (x *Person_AddressBook) ProtoReflect() protoreflect.Message {
	mi := &file_addressbook_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Person_AddressBook.ProtoReflect.Descriptor instead.
func (*Person_AddressBook) Descriptor() ([]byte, []int) {
	return file_addressbook_proto_rawDescGZIP(), []int{0, 1}
}

func (x *Person_AddressBook) GetPeople() []*Person {
	if x != nil {
		return x.People
	}
	return nil
...
var file_addressbook_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xba, 0x03, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04,
	...
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x1a, 0x3a, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x2b, 0x0a, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c,
	0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65,
	0x6f, 0x70, 0x6c, 0x65, 0x22, 0x68, 0x0a, 0x09, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x54, 0x79, 0x70,
	...
	0x10, 0x01, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x48, 0x4f, 0x4e, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45,
	0x5f, 0x4d, 0x4f, 0x42, 0x49, 0x4c, 0x45, 0x10, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x50, 0x48, 0x4f,
	0x4e, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x03, 0x42, 0x3d,
	0x5a, 0x3b, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x61, 0x6d, 0x65, 0x73, 0x68, 0x73, 0x61, 0x6d, 0x70, 0x61,
	0x74, 0x68, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x70, 0x6b,
	0x67, 0x2f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x62, 0x6f, 0x6f, 0x6b, 0x62, 0x06, 0x70,
...
var file_addressbook_proto_goTypes = []interface{}{
	...
	(*Person_PhoneNumber)(nil),    // 2: addressbook.Person.PhoneNumber
	(*Person_AddressBook)(nil),    // 3: addressbook.Person.AddressBook
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	2, // 0: addressbook.Person.phones:type_name -> addressbook.Person.PhoneNumber
	...
	1, // 3: addressbook.Person.AddressBook.people:type_name -> addressbook.Person
...
func file_addressbook_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_addressbook_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Person_AddressBook); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
